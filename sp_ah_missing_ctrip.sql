CREATE OR REPLACE PROCEDURE sp_ah_missing_ctrip
AS
/******************************************************************************

NAME:       sp_ah_missing_ctrip
PURPOSE:    

REVISIONS:
Ver          Date                  Author             Description
---------  ----------          ---------------  ------------------------------------
1.0        02/09/2026           Francis              1. Create sp_ah_missing_ctrip
...
BEGIN 
    ...
    --INSERT CTRIP 
    BEGIN   
            INSERT INTO adw_prod_tgt.TEMP_NLR_PORTFOLIO_PISC_DAILY_MIS 
            (
            ...
            LEFT JOIN adw_prod_tgt.gct_geninfo_ref dc ON dc.refseqno = d.pol_source
            LEFT JOIN adw_prod_tgt.cnb_namelst_trn_v2 cc ON g.nameid = cc.nameid
